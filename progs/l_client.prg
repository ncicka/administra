*       *********************************************************
*       *                                                         
*       * 13/07/2005           L_CLIENT.SPR              11:22:59 
*       *                                                         
*       *********************************************************
*       *                                                         
*       * Nombre del autor                                        
...
*       *********************************************************
*       *                                                         
*       *  L_CLIENT/Windows Código de configuración - SECCION 2   
*       *                                                         
*       *********************************************************
*
...
*       *********************************************************
*       *                                                         
*       *    VCLI/Windows Código de configuración - SECCION 2     
*       *                                                         
*       *********************************************************
*
...
*       *********************************************************
*       *                                                         
*       *        L_CLIENT/Windows Distribución de pantalla        
*       *                                                         
*       *********************************************************
*
...
*       *********************************************************
*       *                                                         
*       *          VCLI/Windows Distribución de pantalla          
*       *                                                         
*       *********************************************************
*
...
*       *********************************************************
*       *                                                         
*       *           L_CLIENT/Windows Código de limpieza           
*       *                                                         
*       *********************************************************
*
...
*       *********************************************************
*
FUNCTION _1kd0oebzp     &&  m.orden VALID
#REGION 1
DO CASE
	CASE m.orden = 1
		SET ORDER TO clientes1
...
*       *********************************************************
*
FUNCTION _1kd0oebzr     &&  m.filtro WHEN
#REGION 1
...
*       *********************************************************
*
FUNCTION _1kd0oebzs     &&  m.filtro VALID
#REGION 1
m.orig_rec = RECNO()
...
*       *********************************************************
*       *                                                         
*       * _1KD0OEBZV           m.imprimir VALID                   
*       *                                                         
*       * Function Origin:                                        
*       *                                                         
*       * From Platform:       Windows                            
*       * From Screen:         L_CLIENT,     Record Number:    7  
*       * Variable:            m.imprimir                         
*       * Called By:           VALID Clause                       
...
*       *********************************************************
*
FUNCTION _1kd0oebzv     &&  m.imprimir VALID
#REGION 1
IF PRINTSTATUS()
	SELECT clientes
	saverec = RECNO()
...
*       *********************************************************
*       *                                                         
*       * _1KD0OEBZW           Nivel de lectura SHOW              
*       *                                                         
*       * Function Origin:                                        
*       *                                                         
*       *                                                         
...
*       *********************************************************
*
FUNCTION _1kd0oebzw     && Read Level Show
PRIVATE currwind
STORE WOUTPUT() TO currwind
*
* Código SHOW de la pantalla: L_CLIENT
*
#REGION 1
